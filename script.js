...
Array.from(aboutMeTextContent).forEach((char) => {
  ...
  span.addEventListener("mouseenter", (e) => {
    e.target.style.animation = "aboutMeTextAnim 0.5s infinite";
  });
});

const aboutGodText = document.querySelector(".about-god-text");
const aboutGodTextContent =
"-             LA VENIDA DE JESUCRISTO ESTA CERCA             -   -------------------------------------------------------------- El ángel me dijo: Estas palabras son verdaderas y dignas de confianza. El señor, el mismo Dios que inspira a los profetas, ah enviado su ángel para mostrar a sus siervos lo que pronto va a suceder. Vengo pronto! dichoso el que hace caso el mensaje profético que esta escrito en este libro!. Yo, Juan, vi y oí estas cosas. Y despues de verlas y oírlas, me arrodillé a los pies del ángel que me las había mostrado, para adorarlo. Pero el me dijo: no hagas eso, pues yo soy siervo de Dios, lo mismo que tú y tus hermanos los profetas y que todos los que hacen caso de lo que esta escrito en este libro. Adora a Dios. Tambien me dijo: no guardes en secreto el mensaje profético que está escrito en este libro, porque ya se acerca el tiempo de su cumplimiento. Deja que el malo siga en su maldad, y que el impuro siga en su pureza; pero el bueno siga haciendo el bien, y que el santo siga santificándose. Sí vengo pronto, y traigo el premio que voy a dar a cada uno conforme a lo que haya hecho. Yo soy el alfa y la omega, el primero y el ultimo, el principio y el fin. Dichosos los que lavan sus ropas para tener derecho al árbol de la vida y poder entrar por las puertas de la ciudad. Pero fuera se quedarán los pervertidos, los que practican la brujería, los que cometen inmoralidades sexuales, los asecinos, los que adoran ídolos y todos los que aman y practican el engańo. Yo, Jesús, he enviado mi angel para declarar todo esto a las iglesias. Yo soy el retońo que desciende de David. Yo soy la estrella brillante de la mańana. APOCALIPSIS 22.6-16";



Array.from(aboutGodTextContent).forEach((char) => {
  const span = document.createElement("span");
  span.textContent = char;
  aboutGodText.appendChild(span);

  span.addEventListener("mouseenter", (e) => {
    e.target.style.animation = "aboutGodTextAnim 0.5s infinite";
  });
});
